...
class _LoginPageState extends State<LoginPage> {
  ...
  void _signIn() async {
    ...
    if (user != null) {
      showToast(message: "User se conectou com sucesso!");
      Navigator.pushNamed(context, "/home");
    } else {
      showToast(message: "Sua senha precisa ter pelo menos 8 caracteres");
    }
  }
...
showToast(message: "Algo deu errado mesmo $e");
    }
